      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center lg:justify-between gap-16">
        ...
        <div className="lg:w-5/12 text-center lg:text-left">
          ...
          <p className="text-gray-700 text-lg mb-8 text-justify">
            ...
            <strong>7 years of experience</strong>. At Gallant Digital, we
            empower businesses through innovation and expertise, creating
            tailored solutions that elevate your digital presence and foster
            sustainable growth. Our proven track record makes us your trusted
          ...
          <p className="text-gray-700 text-lg text-justify">
            Our mission at Gallant Digital is to transform businesses through
            cutting-edge technology solutions. Driven by your goals, unwavering
            integrity, and a dedication to social impact, we envision a future
            where technology is the driving force behind success and meaningful
            change.
          </p>
